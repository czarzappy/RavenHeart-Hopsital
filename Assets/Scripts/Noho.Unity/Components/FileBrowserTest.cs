...
namespace Noho.Unity.Components
{
	...
	public class FileBrowserTest : MonoBehaviour
	{
		...
		public Image LastLoadedBackgroundImage;
		...
		void Start()
		{
			...
			// FileBrowser.SetFilters( true, new FileBrowser.Filter( "Resource Pack" ));
		...
		IEnumerator ShowLoadDialogCoroutine()
		{
			...
			if( FileBrowser.Success )
			{
				...
				foreach (string background in resourcePack.BGs)
				{
					...
					string backgroundName = Path.GetFileNameWithoutExtension(background);

					LastLoadedBackgroundImage.sprite = resourcePack.LoadBackgroundAsSprite(backgroundName);
				}
